...
<Box sx={{ ml: 150, mt: 40 }}>
  <Container><Box sx={{ px: 2, py: 1 }}>
      <Box sx={{ fontSize: 'h4.fontSize', fontWeight: 'bold' }}>Welcome to    
      ...
      <div>
        <TextField
          ...
          sx={{ m: 1}}
          InputProps={{
            startAdornment: <InputAdornment position="start"><EmailIcon /></InputAdornment>, className: classes.input
          }}
        />
        <br></br>
